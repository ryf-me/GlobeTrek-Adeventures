 ...
 * Purpose: Site-wide footer with brand info, navigation, and floating inquiry button
 *
 * This file provides:
 *   1. 4-column footer layout (Brand, Quick Links, Support, Contact Info)
 *   2. Social media icon links (Facebook, Instagram, YouTube, TikTok)
 *   3. Quick navigation links to main pages
 *   4. Support links (FAQ, Terms, Privacy, etc.)
 *   5. Contact information with Material icons
 *   6. CTA button for custom trip requests
 *   7. Copyright bar
 *   8. Floating action button (FAB) for inquiries
 *
 * Dependencies:
 *   - config/session.php (for session access on line 74)
 *
 * Used By:
 *   - index.php (homepage)
...
// Ensure a session is active for the FAB conditional logic
if (session_status() === PHP_SESSION_NONE) session_start();

// Google Material Icons (loaded here for pages that don't include navbar.php)
?>
...
<footer class="site-footer-new">
    ...
    <div class="footer-main-new">
        ...
        <div class="footer-brand-new">
            ...
            <!-- === SOCIAL MEDIA ICONS === -->
            <!-- SVG icons for Facebook, Instagram, YouTube, TikTok -->
        ...
        <div class="footer-contact-new">
            ...
            <!-- CTA button for custom trip requests -->
    ...
    <!-- If user is logged in → goes to inquiries page -->
    <!-- If user is guest → redirects to login page -->
